function [p,data] = readKea4d(pathname)
% -----------------------------------------------------------------
% Read in Kea *.2d data
% -----------------------------------------------------------------
...
% owner ('PROS')integer (4 bytes)
% format ('DATA')integer (4 bytes)
% version ('V1.0' or 'V1.1')integer (4 bytes)
% dataType (500 ... 504)integer (4 bytes)
% xDim (first dimension)integer (4 bytes)
% yDim (second dimension)integer (4 bytes)
% zDim (third dimension)integer (4 bytes)
% qDim (fourth dimension)integer (4 bytes)

p.owner                   =fread(fileid,4,'char'); %owner
p.format                  =fread(fileid,4,'char'); %format
p.version                 =fread(fileid,4,'char'); %version
p.dataType                =fread(fileid,1,'int32'); %dataType, gives dimensionality

p.xDim                    =fread(fileid,1,'int32'); %size xDim
p.yDim                    =fread(fileid,1,'int32'); %size yDim
p.zDim                    =fread(fileid,1,'int32'); %size zDim
p.qDim                    =fread(fileid,1,'int32'); %size qDim
...
%                 % spec2(k,:)  = a(1:2:cnt) - j*a(2:2:cnt);
%                 if cnt == td1*2
%                     spec4(q,l,k,:)  = a(1:2:cnt) - j*a(2:2:cnt);
%                     %         else
%                     %             k
%                     %             break;
%                 end
